...
class SinglePartyItemMobileComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      wishlist: "",
          ...
          <div className="productListInnerContentWrap productListInnerContentWrap_mob">
            ...
            <p className="productPrice productPrice_mob">
              <img
                ...
                alt="INR"
              ></img>{" "}
              <strong> {this.props.partyItemInDetails.variation.price}</strong>
...
export default SinglePartyItemMobileComponent;

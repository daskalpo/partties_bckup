...
class GiftMobileSearch extends React.Component {
    ...
    componentDidMount = () => {
        ...
        this.setState({price_show: price, order: Global.gift_search_values_obj.order})
    }
    ...
    price(e) {
        ...
        let local_price = parseInt(document.getElementsByClassName('irs-from')[0].innerHTML) + ',' + parseInt(document.getElementsByClassName('irs-to')[0].innerHTML.replace(" ", ""));

        this.setState({
            price_show: parseInt(document.getElementsByClassName('irs-from')[0].innerHTML) + ' to ' + parseInt(document.getElementsByClassName('irs-to')[0].innerHTML.replace(" ", ""))
        })
    ...
    order = (e) => {
        Global.gift_search_values_obj.order = e;
    ...
    clear_all_searchParameters = () => {
        ...
        Global.gift_search_values_obj.price="";
...
export default GiftMobileSearch

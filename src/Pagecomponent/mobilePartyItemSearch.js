...
class MobilePartyItemSearch extends React.Component {
    ...
    componentDidMount = () => {
        ...
        this.setState({price_show: price, order: Global.partyitem_search_values_obj.order})
    }

    

    allFieldSearch = () => {
       this.props.refreshPartyItemList();
    }
    ...
    price(e) {
        ...
        Global.partyitem_search_values_obj.price = local_price;
        this.setState({price: local_price});
        this.allFieldSearch();
    }

    order = (e) => {
        Global.partyitem_search_values_obj.order = e;
    ...
    clear_all_searchParameters = () => {
        ...
        Global.partyitem_search_values_obj.price="";
...
export default MobilePartyItemSearch

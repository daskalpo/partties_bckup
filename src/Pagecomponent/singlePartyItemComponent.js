...
class SinglePartyItemComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      wishlist: "",
  ...
  componentDidMount = () => {
    if (!this.props.partyItemInDetails.wishlist) {
  ...
  nevigate = (completeProdDetails) => {
    this.props.history.push(
      "/party-item-detail/" + this.props.partyItemInDetails.slug + ""
    );
  };
  ...
  render() {
    var img = this.props.partyItemInDetails.image.map(function (img, index) {
      if (img.feature == 1) {
    ...
    if (this.props.partyItemInDetails.reviews_count[0] !== undefined) {
      total_reviews = this.props.partyItemInDetails.reviews_count[0]
        .total_reviews;
      rating =
        this.props.partyItemInDetails.reviews_count[0].ratingsum /
        total_reviews;
    ...
    return (
      <div
        id={this.props.whom + this.props.partyItemInDetails.id}
        key={this.props.partyItemInDetails.id}
        className="col-md-3 col-sm-4"
      >
        <div className="productItemList">
          <div
            onClick={this.nevigate.bind(this, this.props.partyItemInDetails)}
          ...
          <div className="productListInnerContentWrap">
            <p className="productName">
              <Link
                onClick={this.nevigate.bind(
                  this,
                  this.props.partyItemInDetails
                )}
              >
                {this.props.partyItemInDetails.name}
              </Link>
            </p>
            ...
            <p className="productPrice">
              ...
              <strong className="card_rs_font">
                {this.props.partyItemInDetails.variation.price}
              </strong>
          ...
          <div className="productCartBtn">
            <Link
              to="#"
              onClick={this.addToCart.bind(this, this.props.partyItemInDetails)}
            >
...
export default SinglePartyItemComponent;

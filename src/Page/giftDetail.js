...
class GIftDetail extends Component {
    ...
    __refreshCake = (price, completeGiftDetails) => {
        completeGiftDetails
            .variations
            .forEach(element => {
                    this.setState({cakeAttribute: completeGiftDetails.variations[0].attribuites});
                    this.setState({active_variation_id: completeGiftDetails.variations[0].id});
                    this.setState({active_weight: completeGiftDetails.variations[0].weight})
            });
        this.setState({completeGiftDetails: completeGiftDetails});
        this.setState({clickedGiftPrice: completeGiftDetails.variations[0].price});
        ...
        return (
            <React.Fragment>
                ...
                <Header
                    ...
                    headerTitle="GiftDetails"
                    history={this.props.history}
                    header_search_text_val={this.state.header_search_text_val}
                    header={this
                    .__header
                    .bind(this)}/>
                <main id="main" className="defaultPageWrapper">{this.state.completeGiftDetails == '' && <div className="loader tops">Loading ...</div>} {(this.state.clickedGiftPrice && this.state.completeGiftDetails) && <GiftDetailsComponent
                        get_product_slug_details={this
                        .__get_gift_slug_details
                        .bind(this)}
                        cakeAttribute={this.state.cakeAttribute}
                        clickedGiftPrice={this.state.clickedGiftPrice}
                        completeGiftDetails={this.state.completeGiftDetails}
                ...
                <ReviewAddModelComponent
                 Title="GiftDetails"
                    ...
                    .__get_gift_slug_details
                    .bind(this)}
                    completeProdDetails={this.state.completeGiftDetails}/>
            </React.Fragment>
        );
